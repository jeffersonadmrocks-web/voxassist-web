...
| Permissões por módulo/ação | REVISAR (ver C3) | C3 resolvido (catálogo travado no servidor) -- falta consolidar as 3 telas concorrentes numa só (ver C5) antes de dar essa área por fechada | — | — | PENDENTE (C5) |
