...
function loginScreen(){
  ...
  <div class="login-brand">VOX<span>ASSIST</span></div><div class="version">WEB • V0.8.12 • HOMOLOGAÇÃO</div>
...
function shell(){
 ...
 <div class="brand">VOX<span>ASSIST</span><small>V0.8.12 WEB</small></div>
