...
let idleTimer;window.vxIdleTimeoutMs=30*60*1000;function resetIdle(){clearTimeout(idleTimer);idleTimer=setTimeout(()=>{clearSession();toast('Sessão encerrada por inatividade.');setTimeout(loginScreen,700)},window.vxIdleTimeoutMs)}
