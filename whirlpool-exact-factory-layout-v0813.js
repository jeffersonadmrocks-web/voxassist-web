...
(function(){
 ...
 function build(form){
   ...
   const totals=$('#wpfTotalParts',form)?.closest('table');if(totals){totals.classList.add('wp-exact-table');doc.appendChild(totals)}
   const budget=$('#wpfBudgetValue',form)?.closest('table');if(budget){budget.classList.add('wp-exact-table');doc.appendChild(budget)}
